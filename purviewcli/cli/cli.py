...
entity_commands = [
    ...
    'add-or-update-business-metadata', 'bulk-update-business-metadata',
    'export-business-metadata', 'validate-business-metadata', 
    'get-business-metadata-status', 'search-business-metadata',
    'get-business-metadata-statistics', 'purge-deleted', 'read-unique-attribute',
...
groups_with_methods = [
    ('account', '_account', 'Account', {
        ...
        'update-account': 'accountUpdateAccount',        'get-collections': 'accountGetCollections',
        ...
        'create-collection': 'accountCreateCollection',
        'update-collection': 'accountUpdateCollection',
        'move-collection': 'accountMoveCollection',
        'get-collection-admins': 'accountGetCollectionAdmins',
        'add-collection-admin': 'accountAddCollectionAdmin',
        'remove-collection-admin': 'accountRemoveCollectionAdmin',
    ...
    ('collections', '_collections', 'Collections', {
        ...
        'get-children': 'collectionsGetChildCollectionNames',
        'move-entities': 'collectionsMoveEntities',
        'get-admins': 'collectionsGetCollectionAdmins',
        'add-admin': 'collectionsAddCollectionAdmin',
        'remove-admin': 'collectionsRemoveCollectionAdmin',
        'get-statistics': 'collectionsGetCollectionStatistics',
        'get-permissions': 'collectionsGetCollectionPermissions',
        'set-permissions': 'collectionsSetCollectionPermissions',
        'bulk-operations': 'collectionsBulkOperations',
        'export': 'collectionsExportCollections',
        'import': 'collectionsImportCollections',
        'validate-hierarchy': 'collectionsValidateHierarchy'
    }),
