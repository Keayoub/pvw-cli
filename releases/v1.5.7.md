...
**Changes:**
- Created centralized `console_utils.py` with `get_console()` utility
- Updated all CLI modules to use smart console detection:
  - `cli.py`, `account.py`, `domain.py`, `entity.py`
  - `health.py`, `glossary.py`, `insight.py`, `lineage.py`
  - `search.py`, `unified_catalog.py`, `workflow.py`
