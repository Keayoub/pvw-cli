# Release v1.2.6 - Advanced Lineage Features & Column-Level Mapping

**Release Date:** November 3, 2025  
**Version:** 1.2.6  
**Previous Version:** 1.2.5

[![Version](https://img.shields.io/badge/version-1.2.6-blue.svg)](https://github.com/Keayoub/pvw-cli/releases/tag/v1.2.6)
...
**Features:**
- ✅ Multi-target support (1 source → N targets)
- ✅ Type validation (compatible entity types)
- ✅ Column mapping (Source:Sink pairs)
...
1. **`lineageCreateColumnLevel()`**
   ...
   - Supports multi-target (1 source → N targets)
...
**Tested Scenarios:**
- ✅ Column-level lineage with single target
- ✅ Column-level lineage with multiple targets (1→N)
- ✅ Direct lineage without column mapping
- ✅ Direct lineage with column mapping
- ✅ CSV import with mixed lineage types
- ✅ CSV import with optional column_mapping field
- ✅ Type validation (compatible/incompatible types)
- ✅ UI display verification (Purview portal)

**Entity Types Tested:**
- `azure_sql_table` → `azure_sql_table`
- `azure_sql_table` → `azure_sql_view`
- `fabric_lakehouse_table` → `fabric_lakehouse_table`
...
3. **Type Compatibility**
   ...
   - Cross-platform lineage (e.g., SQL → Fabric) requires compatible types

---

## 🎯 Next Steps (v1.2.7 Roadmap)
...
**Full Changelog:** [v1.2.5...v1.2.6](https://github.com/Keayoub/pvw-cli/compare/v1.2.5...v1.2.6)
