...
<script type="text/javascript" src="https://cdnjs.buymeacoffee.com/1.0.0/button.prod.min.js" data-name="bmc-button" data-slug="ayoubkebaiq" data-color="#FFDD00" data-emoji=""  data-font="Cookie" data-text="Buy me a coffee" data-outline-color="#000000" data-font-color="#000000" data-coffee-color="#ffffff" ></script>
...
> **LATEST UPDATE v1.3.5 (November 3, 2025):**
>
...
>
> **[Full Release Notes v1.3.5](releases/v1.3.5.md)** | **[v1.2.5 Release Notes](releases/v1.2.5.md)** | **[Migration Guide](releases/v1.3.5.md#migration-guide)**

---

## What is PVW CLI?

**PVW CLI v1.3.5** is a modern, full-featured command-line interface and Python library for Microsoft Purview. It enables automation and management of *all major Purview APIs* with **86% Unified Catalog API coverage** (45 of 52 operations).
...
### v1.3.5 (November 3, 2025) - Advanced Lineage Features
...
**[Full v1.3.5 Release Notes](releases/v1.3.5.md)**
...
**[View Full Release Notes](releases/v1.3.5.md)**
...
**PVW CLI v1.3.5** is a modern command-line interface and Python library for Microsoft Purview, enabling:
...
**PVW CLI v1.3.5 empowers data engineers, stewards, and architects to automate, scale, and enhance their Microsoft Purview experience with powerful command-line and programmatic capabilities.**
