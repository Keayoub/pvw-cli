# PURVIEW CLI v1.0.13 - Microsoft Purview Automation & Data Governance
...
**PVW CLI v1.0.13** is a modern, full-featured command-line interface and Python library for Microsoft Purview. It enables automation and management of *all major Purview APIs* including:
...
**PVW CLI v1.0.13** is a modern command-line interface and Python library for Microsoft Purview, enabling:
...
**PVW CLI v1.0.13 empowers data engineers, stewards, and architects to automate, scale, and enhance their Microsoft Purview experience with powerful command-line and programmatic capabilities.**
