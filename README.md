# PURVIEW CLI v1.7.1 - Microsoft Purview Automation & Data Governance

[![Version](https://img.shields.io/badge/version-1.7.0-blue.svg)](https://github.com/Keayoub/pvw-cli/releases/tag/v1.7.1)
...
> **LATEST UPDATE v1.7.1 (January 28, 2026):**
>
...
>
> **[Full Release Notes v1.7.1](releases/v1.7.1.md)** | **[New APIs Guide](doc/guides/UC_NEW_APIS_GUIDE.md)** | **[API Coverage Analysis](doc/UC_API_COVERAGE_ANALYSIS.md)**
>
> **Previous Update v1.7.1 (January 27, 2026):**
>
...
**PVW CLI v1.7.1** is a modern, full-featured command-line interface and Python library for Microsoft Purview. It enables automation and management of *all major Purview APIs* with **96% Unified Catalog API coverage** (46 of 48 operations).
...
**Latest Release:** [v1.7.1](releases/v1.7.1.md) (January 28, 2026)  
...
### 🎯 New in v1.7.1 - Six Advanced UC APIs
...
### **Unified Catalog (UC) - 96% Complete ⭐ NEW in v1.7.1**
...
- **New APIs Guide:** [UC New APIs v1.7.1](doc/guides/UC_NEW_APIS_GUIDE.md)
...
**PVW CLI v1.7.1 empowers data engineers, stewards, and architects to automate, scale, and enhance their Microsoft Purview experience with powerful command-line and programmatic capabilities.**
