# PURVIEW CLI v1.9.1 - Microsoft Purview Automation & Data Governance

[![Version](https://img.shields.io/badge/version-1.8.5-blue.svg)](https://github.com/Keayoub/pvw-cli/releases/tag/v1.9.1)
...
> **LATEST UPDATE v1.9.1 (February 6, 2026):**
>
...
>
> **[Full Release Notes v1.9.1](releases/v1.9.1.md)** | **[CSV Column Reference](samples/csv/UC_TERMS_CSV_COLUMNS_REFERENCE.md)** | **[CSV Examples](samples/csv/)**
>
...
**PVW CLI v1.9.1** is a modern, full-featured command-line interface and Python library for Microsoft Purview. It enables automation and management of *all major Purview APIs* with **96% Unified Catalog API coverage** (46 of 48 operations).
...
**Latest Release:** [v1.9.1](releases/v1.9.1.md) (February 6, 2026)  
...
**PVW CLI v1.9.1 empowers data engineers, stewards, and architects to automate, scale, and enhance their Microsoft Purview experience with powerful command-line and programmatic capabilities.**
