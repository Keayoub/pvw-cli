...
[![Version](https://img.shields.io/badge/version-1.3.3-blue.svg)](https://github.com/Keayoub/pvw-cli/releases/tag/v1.5.0)
...
> **LATEST UPDATE v1.5.0 (November 3, 2025):**
>
...
>
>
> **[Full Release Notes v1.5.0](releases/v1.5.0.md)** | **[v1.3.3 Release Notes](releases/v1.3.3.md)** | **[Migration Guide](releases/v1.5.0.md#migration-guide)**

---

## What is PVW CLI?

**PVW CLI v1.5.0** is a modern, full-featured command-line interface and Python library for Microsoft Purview. It enables automation and management of *all major Purview APIs* with **86% Unified Catalog API coverage** (45 of 52 operations).
...
### v1.5.0 (November 3, 2025) - Advanced Lineage Features
...
**[Full v1.5.0 Release Notes](releases/v1.5.0.md)**
...
**[View Full Release Notes](releases/v1.5.0.md)**
...
**PVW CLI v1.5.0** is a modern command-line interface and Python library for Microsoft Purview, enabling:
...
**PVW CLI v1.5.0 empowers data engineers, stewards, and architects to automate, scale, and enhance their Microsoft Purview experience with powerful command-line and programmatic capabilities.**
