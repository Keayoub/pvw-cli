...
See the [CLI Reference](cli/README.md) for a full list of command groups and their documentation. For granular command docs, see the [docs/commands/](../../commands/) directory.
