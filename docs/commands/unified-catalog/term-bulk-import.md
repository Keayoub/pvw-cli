...
- **Unified Catalog Overview:** `docs/commands/unified-catalog.md`
- **Term Management:** `docs/commands/unified-catalog/term.md`
- **Domain Management:** `docs/commands/unified-catalog/domain.md`
